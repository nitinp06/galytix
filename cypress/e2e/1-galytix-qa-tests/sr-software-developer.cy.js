describe('Job Application Page', () => {
  ...
  it('should display and fill the application form', () => {
    ...
    cy.get('.applyNowForm').should('exist')
    ...
    // Fill form
    cy.get('input[name="name"]').type('Nitin Parashar')
    cy.get('input[name="email"]').type('nitin.parashar@outlook.com')
